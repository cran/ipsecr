...
| max.nsim     | 2000       | maximum number of simulations (excluding for var-covar) | 
...
# ignore message "Registered S3 method overwritten by 'DoE.base'" etc.
```
...
This message may not be terminal. The target precision is arbitrary. 
